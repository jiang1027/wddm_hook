...
typedef struct _VIDPN_PATH_DATA
{
	D3DDDI_VIDEO_PRESENT_TARGET_ID	VidPnTargetId;
	D3DDDI_VIDEO_PRESENT_SOURCE_ID	VidPnSourceId;
	D3DKMDT_VIDPN_PRESENT_PATH*		VidPnPath;
	D3DKMDT_HVIDPNSOURCEMODESET		VidPnSourceModeSet;
	DXGK_VIDPNSOURCEMODESET_INTERFACE* VidPnSourceModeSetInterface;
	D3DKMDT_HVIDPNTARGETMODESET		VidPnTargetModeSet;
	DXGK_VIDPNTARGETMODESET_INTERFACE* VidPnTargetModeSetInterface;

} VIDPN_PATH_DATA, *PVIDPN_PATH_DATA;
